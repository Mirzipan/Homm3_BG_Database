...
___
<p style="text-align: center;" markdown>:activation: On a chosen empty space:<br><br>:empower: 0 ➣ No effect<br>:empower: 2 ➣ [**Summon**](../keywords/summon.md) a [Few Earth Elementals](../units/earth_elementals.md)<br>:empower: 4 ➣ [**Summon**](../keywords/summon.md) a [Pack of Earth Elementals](../units/earth_elementals.md)<br><br>— OR —<br><br>:instant: +1 :empower:</p>
___
