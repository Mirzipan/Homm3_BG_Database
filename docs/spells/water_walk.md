...
___
<p style="text-align: center;" markdown>:effect_map: Choose one of your [Heroes](../heroes/index.md). They gain * and can continue their movement after entering a [sea field](../fields/sea_field.md) from a [land field](../fields/land_field.md).<br><br>:empower: 0 ➣ \*+0 :movement:<br>:empower: 1 ➣ \*+1 :movement:<br>:empower: 2 ➣ \*+2 :movement:<br><br>— OR —<br><br>:instant: +1 :empower:</p>
___
