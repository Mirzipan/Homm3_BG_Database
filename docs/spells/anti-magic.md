...
___
<p style="text-align: center;" markdown>:ongoing: Until the end of the Combat, the selected \* [unit](../units/index.md) cannot be targeted by spells:<br><br>:power: 0 ➣ \*:bronze_tier:<br>:power: 2 ➣ \*:bronze_tier: or :silver_tier:<br>:power: 4 ➣ \*:bronze_tier: or :silver_tier: or :golden:<br><br>— OR —<br><br>:instant: +1 :power:</p>
___
