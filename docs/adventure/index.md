...
| Pandora's Box | Roll 2 [:treasure:](../keywords/dice.md#treasure-die) and resolve 1 of them. Draw 1 [Negative Morale](../keywords/morale.md#negative) card.<br><br>— OR —<br><br>Roll 2 [:resource_die:](../keywords/dice.md#resource-die) and resolve 1 of them. Draw 1 [Positive Morale](../keywords/morale.md#positive) card. |
...
| Treasure Chest | Roll 2 [:treasure:](../keywords/dice.md#treasure-die) and resolve 1 of them. |
