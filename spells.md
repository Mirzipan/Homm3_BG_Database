...
| Name | Effect |
| :--- | :---: |
| Disrupting Ray | 🔄 Until the end of the Combat, the selected \* [unit](units.md) cannot use their special ability:<br><br> 📖0 - \*🥉<br>📖1 - \*🥉 or 🥈<br>📖2 - \*🥉 or 🥈 or 🥇 |
| Fortune | ⚡️ Reroll one [Treasure](dice.md#treasure-die), [Resource](dice.md#resource-die), or [Attack die](dice.md#attack-die) \*. Resolve the result of your choice<br><br> 📖0 - \*once<br>📖1 - \*twice<br>📖2 - \*3 times |
...
| Name | Effect |
| :--- | :---: |
| Chain Lightning | ➡️ Select a [unit](units.md) and another 2 [units](units.md) closest to it. Allocate \*❤️‍🩹, starting with the first selected [unit](units.md).<br><br> 📖0 - 1/1/1❤️‍🩹<br>📖2 - 2/1/1❤️‍🩹<br>📖4 - 3/2/1❤️‍🩹 |
| Counterstrike | ⚡️ Remove the Black cube from the selected \* [Unit](units.md) card - that [unit](units.md) is now able to perform a Retaliation Attack action again:<br><br> 📖0 - \*🥉<br>📖2 - \*🥉 or 🥈<br>📖4 - \*🥉 or 🥈 or 🥇 |
| Dimension Door | 🌍 Move a Hero up to \* field(s). Ignore any obstacles and fields in-between and resolve the last one normally.<br><br> 📖0 - \*1<br>📖2 - \*2<br>📖4 - \*3 |
...
| Resurrection | ⚡️ Cancel an attack that would reduce your \* unit's ❤️ to 0. You can cast this spell immediately after the enemy unit's attack.<br><br> 📖0 - \*🥉<br>📖2 - \*🥉 or 🥈<br>📖4 - \*🥉 or 🥈 or 🥇 |
| Sorrow | ⚡️ When a \* [unit](units.md) is about to activate, skip this unit's activation.<br><br> 📖0 - \*🥉<br>📖2 - \*🥉 or 🥈<br>📖4 - \*🥉 or 🥈 or 🥇 |
...
| Name | Effect |
| :--- | :---: |
| Blind | ➡️ Place a 🐍 token on the selected \* unit:<br><br> 📖0 - \*🥉<br>📖2 - \*🥉 or 🥈<br>📖4 - \*🥉 or 🥈 or 🥇 |
...
| Name | Effect |
| :--- | :---: |
| Berserk | 🔄 Select a \* [unit](units.md). In its activation, this [unit](units.md) must either attack the nearest [unit](units.md) or move to the nearest [unit](units.md) and attack it.<br><br> 📖0 - \*🥉<br>📖2 - \*🥈<br>📖4 - \*🥇 |
...
| Fireball | ➡️ Select 2 adjacent places. Deal \*❤️‍🩹 to [units](units.md) in these spaces.<br><br> 📖0 - 1❤️‍🩹<br>📖2 - 2❤️‍🩹<br>📖4 - 3❤️‍🩹 |
| Frenzy | ⚡️ This [unit](units.md) ignores the 🛡️ of the attacked \* [unit](units.md).<br><br> 📖0 - \*🥉<br>📖2 - \*🥉 or 🥈<br>📖4 - \*🥉 or 🥈 or 🥇 |
...
| Prayer | ⚡️ The selected [unit](units.md) gains \*⚔️, 🛡️, or 🤺:<br><br> 📖0 - \*+1<br>📖2 - \*+2<br>📖4 - \*+3 |
| Teleport | ➡️ During Combat, move one allied \* [unit](units.md) to any empty space - ignore any obstacles or effects when moving.<br><br> 📖0 - \*🥉<br>📖1 - \*🥉 or 🥈<br>📖2 - \*🥉 or 🥈 or 🥇 |
